...
class Options():
    ...
    def initialize(self):
        ...
        self._parser.add_argument('-w','--warp', default='tps')
        ...
        self._parser.add_argument('-ld','--lr_drift', default=0.001, type=float, metavar='PATH', help='learning rate gan')
        ...
        self._parser.add_argument('--crop', type=eval, default=True, help='Enable/disable cropping')
